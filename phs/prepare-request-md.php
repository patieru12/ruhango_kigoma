    	...
    	<table cellpadding="0" cellspacing="0" style='font-size:14px;'>
    		<tr>
				...
				<td>
					...
					<div class=stock_status style='border:0px solid #000; max-height:490px;  min-height:490px; width:450px; overflow:auto;'>
				...
				<td>
					...
					<form action="./receive-request-md.php" method=post>
						...
						<input type=submit id='confirm' title='Approve That you received Requested Medicines' class=flatbtn-blu style='font-size:12px;' name='confirm' value='Request Received' />
						<input type=button name='print' onclick='click_now();' title='Print the list of requested medicines' class=flatbtn-blu style='font-size:12px;'  value='Print Request' />
					</form>

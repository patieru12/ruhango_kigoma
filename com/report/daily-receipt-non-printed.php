...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Download Daily Receipt</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("daily-receipt-data-non-printed.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

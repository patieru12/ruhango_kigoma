...
?>
  <div id="w" style='height: auto;'>
    <div id="content" style='height: auto;'>
    	<b>
		<h1 style='text-align: center; margin-top:-55px;'>Family Planning Data Entry</h1>
							...
							<tfoot>
								<tr>
									<td style="border:1px solid #fff; border-top:1px solid #000; padding-top: 5px;">
										<table>
											<tr>
												<td style="font-size: 12px;">Medicine Name<span id=barEdit style='position:relative; top:24px; left:100%; height:0px;'>&nbsp;</span></td>
											</tr>
											<tr>
												<td>

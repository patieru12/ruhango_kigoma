...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Anti-Malaria Distribution</h1>
      <b>
	...
	<!--
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found">
		<span class=error-text>Press Generate to view Daily Coartem Distribution</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("coartem_unpaid_data_monthly.php?year=" + $("#year").val() + "&month=" + $("#month").val() + "&post=" + $("#post").val());
	});

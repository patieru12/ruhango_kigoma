...
<label id='anotheract'>
<img style='cursor:pointer; position:relative; top:-15px; left:145px;'  width='15px' title='Add New Medicine' src="../images/256.png" /></label>
<script>
	$('#anotheract').click(function(){
		$(".acts<?= ($_GET['number'] + 1) ?>").load("./adds-on/acts.php?number=<?php echo ($_GET['number'] + 1) ?><?= @$_GET['code'] == 2?"&code=21":"" ?><?= @$_GET['code'] == 4?"&code=4":"" ?>");

...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Daily Laboratory Records</h1>
      <b>
	...
	<tr>
	  ...
	  <table class=list-1><tr><td>Post</td><td>Year</td><td>Month</td><td>Day From</td><td>Day to</td><td><label for='exam'>Exam</label></td></tr>
	  <tr>
	  <td>
	  <?php
...
$(document).ready(function(){
	...
	$(".day2").load("load_day2.php?year=" + $("#year").val() + "&month=" + $("#month").val());
	...
	$("#generate").click(function(e){
		...
		if (exam.val() != "") {
			...
			var dt2 = year.val() + '-' + month.val() + '-' + day2.val();
			exam = exam.val();

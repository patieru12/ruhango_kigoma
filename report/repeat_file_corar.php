...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Repeated Documents CORAR</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found">
		<span class=error-text>Select Post to view Repeated File For CORAR </span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("repeat_file_data_corar.php?key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Daily Consumables Consumption</h1>
      <b>
...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<!--
	  ...
	  <table class=list-1><tr><td></td><td colspan=2>Month</td><td>Medicine</td></tr>
	  <tr>
	  <td>
	  <?php
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("consu_medicines_cn.php?year=" + $("#year").val() + "&month=" + $("#month").val() + "&medicine=" + $("#medecines").val().replace(" ","%20") + "&post=" + $("#post").val());
	});

...
<tr><th colspan=4></th><th colspan=4>Coartem</th><th colspan=3>&nbsp;</th></tr>
<tr><th>#</th><th>Patient</th><th>Code</th><th>Category</th>";
$str .= $tb_data;
...
for($i=0;$i<count($medecines);$i++){
	...
	if($medecines[$i]['Name'] != 'Total'){
		...
		$str .= "<td colspan=4 style='text-align:center;'>&nbsp;</td>";

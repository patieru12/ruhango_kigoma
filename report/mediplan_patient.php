...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
																																												<!--	Total	85%-->
		<tr><th>No</th><th>Service</th><th>No de Police</th><th>Date</th><th>No du bénéficiaire</th><th>Nom et Prénom du bénéficiaire</th><th>Consultation</th><th>Examens</th><th>Imaging</th><th>Hospitalisation</th><th>Acte</th><th>Consommables</th><th>Medicaments</th><th>Autres</th><th>Total</th><th>Total 85%</th></tr>
		<?php
		$t = array();
		$data = array();

		$data[] = array("No","Service","No Police","Date","No du bénéficiaire","Nom et Prénom du bénéficiaire","Consultation","Examens","Imaging","Hospitalisation","Acte","Consumables","Medicaments","Autres","Total","Total 85%");
	...
	if(count($data)>0){
		...
		$_SESSION['report_title'] = array("title"=>"RELEVE DES FACTURES MEDIPLAN No {$_GET['year']}/{$_GET['month']}");
		?>
		<style>
			.img_links{
				height:40px; 
		...
		<a href='./print_report.php?format=excel&in=mediplan' target="_blank"><img title="View in EXCEL" src="../images/excel.png" class=img_links width=40px /></a>
		<?php
	}

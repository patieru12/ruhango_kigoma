...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Repeated Documents CBHI</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("repeat_file_data.php?rg=generate&key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

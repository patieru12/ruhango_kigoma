...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Repeated Documents MMI</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("empty_file_data_mmi.php?key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

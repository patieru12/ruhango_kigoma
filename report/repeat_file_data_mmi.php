...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		<tr><th>ID</th><th>Date</th><th>Insurance</th><th>Age</th><th>Sex</th><th>Name</th><th>Affiliate</th><th>Cons Cost</th><th>Lab</th><th>Imaging</th><th>Hosp.</th><th>Proc & Mat.</th><th>Consum.</th><th>Drugs.</th><th>Total</th><th>Dett. Fees</th><th>Total to be Paid</th></tr>
		<?php
		$t = array();
		$data = array();
	...
	if(count($data)>0){
		...
		<a href='./print_report.php?format=excel&in=mmi' target="_blank"><img title="View in EXCEL" src="../images/excel.png" class=img_links width=40px /></a>
		<?php
	}

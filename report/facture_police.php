...
//die;
$insurance = formatResultSet($rslt=returnResultSet($sql="SELECT DISTINCT in_name.* from in_name, in_category WHERE in_name.CategoryID=in_category.InsuranceCategoryID && in_name.InsuranceName='Police' ORDER BY InsuranceCode ASC, InsuranceName DESC",$con),$multirows=true,$con);
...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Summary For Patients received from RNP</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='height:93%; overflow:auto;'>
		<span class=error-text>Select Post to view RNP monthly bill</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("police_patient.php?key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

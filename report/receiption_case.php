...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Money In Caisse</h1>
      <b>
	...
	<!--
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found">
		<span class=error-text>Press Generate to view Money In Caise</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("receiption_case_data.php?year=" + $("#year").val() + "&month=" + $("#month").val() + "&medicine=ALL&post=" + $("#post").val());
	});

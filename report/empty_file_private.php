...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Private Documents Summary</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found">
		<span class=error-text>Select Post to view empty Documents Summary</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("empty_file_data_private.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});
	setTimeout(function(){
		$("#generate").click();
	},500);

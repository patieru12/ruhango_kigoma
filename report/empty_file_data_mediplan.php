...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		...
		$t = array();
		$data = array();
		$data[] = array("Nr","Date","Insurance","Age","Sex","Name","Affiliate","Cons Cost","Lab","Imaging","Hosp","Procedures","Consumables","Drugs","Total","Detterent","Total to be paid");
		$c_i = 0;
	...
	if(count($data)>0){
		...
		$_SESSION['report_title'] = array("title"=>"EMPTY FILE MEDIPLAN");
		?>
		<style>
			.img_links{
				height:40px; 

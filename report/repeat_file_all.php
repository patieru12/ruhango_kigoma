...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>All Repeated Documents</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='height:95%; border:0px solid #000;'>
		<span class=error-text>Select Post to view CBHI Repeated Documents</span>
	  </div>
	  </b>
    </div>
  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("repeat_file_data_all.php?rg=generate&key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		<tr><th>ID</th><th>Date</th><th>Insurance</th><th>Age</th><th>Sex</th><th>Name</th><th>Affiliate</th><th>Family Code</th><th>Cons Cost</th><th>Lab</th><th>Imaging</th><th>Hosp.</th><th>Proc & Mat.</th><th>Consum.</th><th>Drugs.</th><th>Total</th><th>Dett. Fees</th><th>Total to be Paid</th></tr>
		<?php
		$t = array();
		$data = array();
		$data[] = array("Nr","Date","Insurance","Age","Sex","Name","Affiliate","Family Code","Cons Cost","Lab","Imaging","Hosp","Procedures","Consumables","Drugs","Total","Detterent","Total to be paid");
		$c_i = 0;
	...
	if(count($data)>0){
		...
		$_SESSION['report_title'] = array("title"=>"EMPTY FILE RSSB RAMA");
		?>
		<style>
			.img_links{
				height:40px; 
		...
		<a href='./print_report.php?format=excel&in=rama' target="_blank"><img title="View in EXCEL" src="../images/excel.png" class=img_links width=40px /></a>
		<?php
	}

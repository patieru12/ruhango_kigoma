...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Malaria Summary</h1>
      <b>
	...
	<!--
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found">
		<span class=error-text>Press Generate to view Malaria Summary</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		if(!$("#post").val()){
			$("#ds").addClass("error-text");
			$("#ds").html("Please Select the Post!");
			return e.preventDefault();
		}
		$(".patient_found").load("malaria_summary_data.php?year=" + $("#year").val() + "&month=" + $("#month").val() + "&medicine=ALL&post=" + $("#post").val());
	});

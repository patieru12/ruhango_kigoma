...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Facture MEDIPLAN</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='height:93%; overflow:auto;'>
		<span class=error-text>Select Post to view MEDIPLAN monthly bill</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("mediplan_patient.php?key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

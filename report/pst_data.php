...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		<tr><th>ID</th><th>Date</th><th>Code Beneficiaire</th><th>Name</th><th>Chef de Famille</th><th>Consul.</th><!--<th>Labo</th><th>Price</th>--><th colspan=4>Medicines</th><th>Hosp</th><th>Price</th><th>Actes</th><th>Price</th><th>Consum.</th><th>Price</th><th>G. Total</th><!--<th>TM</th><th>Payable Total</th>--></tr>
		...
		$kk_ = "";
		$data = array();
		$data[] = array("ID","Date","Code Bebeneficiaire","Nom Beneficiaire","Chef de Famille","Consul.","Test Labo","Price","Medicines","Hosp.","Price","Act","Price","Consum","Price","General Total");

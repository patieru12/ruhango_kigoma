	...
	<div id='w' style='height: auto;'>
		...
		<tr>
			...
			<div id="content" style='height: auto;'>
				<h1 style='margin-top:-55px'>Uploading Medicine Tarif Document <a href='./uploads/medicine_tarif_tmp.xlsx'>xls</a></h1>
				<b>
					<?= $error ?>
					<label id=out_put></label>
				</b>
				<form action="upload_medicine.php" id="act_frm" method=post enctype="multipart/form-data">

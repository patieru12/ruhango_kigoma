<?php
	...
	if (isset($_POST['save_name'])) {
		//var_dump($_POST); die;
		$name = mysql_real_escape_string(trim($_POST['cst_name']));
    			...
    			<td>
    				...
    				<table>
    					<form action='' method='post'>
			    			<tr>
			    				<td><label for='in_name' >Consultation:</label></td>
	  				...
	  				<?php
						...
						$e_list = array();
						$e_list_r = array();
						echo "<select name=cst_name style='width:300px;font-size:16px;' class=txtfield1>";
	  					while ($list = mysql_fetch_assoc($query)) {
							$e_list_r[] = array("name"=>$list['ConsultationCategoryName'],"id"=>$list['ConsultationCategoryID']);
	  				?>

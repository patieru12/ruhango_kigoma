...
saveData($sql,$con);
//if the updated field is the BuyingPrice automatically update the Amount Field
if($_POST['field'] == "BuyingPrice"){
	saveData("UPDATE `{$_POST['tbl']}` SET Amount='".($_POST['val'] + round(($_POST['val']*20)/100,1))."' WHERE `{$_POST['ref_field']}`='{$_POST['ref_val']}'");
}
//echo $sql;

	...
	<div id='w' style='height: auto;'>
		...
		<tr>
			...
			<div id="content" style='height: auto;'>
				<h1 style='margin-top:-55px'>Uploading Act Tarif Document <a href='./uploads/act_tarif_tmp.xlsx'>xls</a></h1>
				<b>
					<?= $error ?>
					<label id=out_put></label>
				</b>
				<form action="upload_act.php" id="act_frm" method=post enctype="multipart/form-data">

...
//die;
$insurance = formatResultSet($rslt=returnResultSet($sql="SELECT DISTINCT in_name.* from in_name, in_category WHERE in_name.CategoryID=in_category.InsuranceCategoryID && in_name.InsuranceName='CORAR' ORDER BY InsuranceCode ASC, InsuranceName DESC",$con),$multirows=true,$con);
$active = "report";
...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='' class="title_bar">Document List CORAR</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("document_list_corar_sp.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
	setTimeout(function(){
		$("#generate").click();

...
STR;
			$str = <<<STR
			 ...
			 $("#father").val("{$patients[$i]["AffiliateName"]}");
			 ...
			 if("{$patients[$i]["AffiliateGender"]}" == "Male" || "{$patients[$i]["AffiliateGender"]}" == "M"){
				$("#affmale").attr("checked",":true");
			 }
			 if("{$patients[$i]["AffiliateGender"]}" == "Female" || "{$patients[$i]["AffiliateGender"]}" == "F"){
			 ...
			 $("#location").val("{$patients[$i]["AffiliateAge"]}");

	  ...
	  <input type=hidden id='patient_id' name='patient_id' />
	  	<table border=0 class="a" style='background-color:#fff;'>
			...
			<tr class="patient_found_search">
				<td colspan="6">
				<a href='./force-selection-mediplan.php' id=display_now rel="#overlay"><img src='../images/view.png' style='width:0px;' /></a>
		...
		if(e.which == 13 ){
			...
			if(docsearch ==false){
				...
				setTimeout(function(e){
					$(".patient_found").load("search_patient_mediplan.php?key="+$("#DailyNumberID").val().replace(" ","_") + "&ins=" + $("#insurance").val() + "&date=" + $("#date").val());

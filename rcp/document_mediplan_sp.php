...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='' class="title_bar">Document List MEDIPLAN</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("document_list_mediplan_sp.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
	setTimeout(function(){
		$("#generate").click();

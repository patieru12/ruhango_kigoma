...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <form method=post action="rcv_patient_mmi.php" id='rcv_patient_frm'>
	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		<tr>
			...
			Consultation Date: <input id="date" type=text name='date' onblur='setTimeout("ds_hi()",1000)' class='txtfield1' onclick="ds_sh(this,'date')" style='width:150px;' value='<?php echo date("Y-m-d",time()) ?>' />
				...
				<td colspan="2">
					Serial Number: <input id="DailyNumberID" type=text name='DailyNumberID' class='txtfield1' style='width:200px;' placeholder="Daily Number" />
		...
		<tr class="patient_found_search">
			<td colspan="6">
			<a href='./force-selection-mmi.php' id=display_now rel="#overlay"><img src='../images/view.png' style='width:0px;' /></a>
...
$(document).ready(function(){
		...
		if(e.which == 13 ){
			...
			if(docsearch ==false){
				...
				setTimeout(function(e){
					$(".patient_found").load("search_patient_mmi.php?key="+$("#DailyNumberID").val().replace(" ","_") + "&ins=" + $("#insurance").val() + "&date=" + $("#date").val());
	...
	$("#patient_search").keyup(function(e){
		...
		$(".patient_found").load("search_patient_mmi.php?key="+$("#patient_search_").val().replace(/ /g,"_") + "&ins=" + $("#insurance").val() + "&date=" + $("#date").val());
		return e.preventDefault();
	});

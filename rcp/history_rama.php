...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Patient List RSSB RAMA</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='max-height:430px;'>
		<span class=error-text>Select Post to view RSSB RAMA Patient History</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("patient_list_rama.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		...
		for($i=0;$i<count($patients);$i++){
			...
			$kk_ .= "<tr>
					...
					<a href='./print_bill.php?record={$patients[$i]['PatientRecordID']}' title='Click to Reprint!' target='_blank' style='color:blue; text-decoration:none;'>{$total}</a>

	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		...
		<tr>
			<td colspan=4>
				...
				<input id="date" type=text name='date' onblur='setTimeout("ds_hi()",1000)' class='txtfield1' onclick="ds_sh(this,'date')" style='width:150px;' value='<?php echo date("Y-m-d",time()) ?>' />
			</td>
		<tr>
		<tr>

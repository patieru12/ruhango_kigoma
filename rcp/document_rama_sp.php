...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Document List RSSB RAMA</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("document_list_rama_sp.php?key=" + $("#insurance").val() + "&day=" + $("#day").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
	setTimeout(function(){
		$("#generate").click();
	}, 500);

...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<table border=0 style='background-color:#fff;'>
		<tr>
			...
			<td>
				Patient ID: <input id="patientIDSearch" type=text name='patientIDSearch' onblur='' class='txtfield1' onclick="" style='width:100px;' value='' />
				<input type=button id=searchById class="flatbtn-blu" name=seachByID value='Search' />
			</td>
		</tr>
		<tr>
			...
			<input id="patient_search" autocomplete="off" type=hidden name='card_id' class='txtfield1' style='' />
				<table border=0 style='width:200px; text-align:center;'>
					...
					<tr>
						...
						<td style='width:100px;'>/<input type=text autocomplete="off" class='txtfield1' id=pa style='width:85%; font-size:12px;' /></td>
					</tr>
				</table>
		...
		<tr>
			...
			<td class=fcategorydata colspan=3>
				...
				<label style="cursor:pointer;"><input type=radio onclick="$('#fcategory').val(2)" name=cbhi_category value='2' id='cbhi_category1'>Category 2</label>
				<label style="cursor:pointer;"><input type=radio onclick="$('#fcategory').val(3)" name=cbhi_category value='3' id='cbhi_category1'>Category 3</label>
				<label style="cursor:pointer;"><input type=radio onclick="$('#fcategory').val(4)" name=cbhi_category value='4' id='cbhi_category1'>Category 4</label>
			</td>
		...
		<tr>
			<td>Weight</td><td>Temperature</td><!-- <td>Length</td><td>Respiration</td><td>Blood Pressure</td><td>Pulse</td><td>SPO2</td><td>Blood Group</td>-->
		</tr>
		<tr>
			...
			<td class=tm_view colspan=2 style='border:0px solid #000;'>
				<label>
					<input type=radio id='paid' name='tm' value='200' />TM Paid
				</label>
				<input type=text id=receipt_number name=receipt_number class=txtfield1 style='width:70px;' placeholder='Receipt Number' />
...
$(document).ready(function(){
	...
	$("#pa").keyup(function(e){
		//setTimeout(function(e){
		$("#patient_search").val($("#di").val() + "/" + $("#se").val() + "/" + $("#pa").val());
		//nextField("pa",8,"name");

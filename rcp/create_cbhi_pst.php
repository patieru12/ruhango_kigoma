...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <span onclick='window.location="./create_cbhi_pst.php"' class='cbhi_pst' style='' title='Click Here If Patient has A Code'>Pansement</span>
	  ...
	  <table border=0 style='background-color:#fff;'>
		...
		<tr class="patient_found_search">
			<td colspan="6"><div class="patient_found"></div></td>
		...
		<input type=submit id=save class="flatbtn-blu" name=rcv_patient value='Save' /> <input type=reset class="flatbtn-blu" onclick='window.location="./create_cbhi.php";' value='Clear' /></td></tr>
	  </table>
...
$(document).ready(function(){
	...
	$("#pa").keyup(function(e){
		...
		//nextField("pa",8,"name");
		//try to search if the code family remain only one character
		if($("#pa").val().length == 8){

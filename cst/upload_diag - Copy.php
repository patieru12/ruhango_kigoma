	...
	<div id='w' style='height: auto;'>
		...
		<tr>
			...
			<div id="content" style='height: auto;'>
				<h1 style='margin-top:-55px'>Uploading Diagnostic Document <a href='./uploads/diagnostic_full_tmp.xlsx'>xls</a></h1>
				<b>
					<?= $error ?>
					<?php
				...
				<form action="upload_diagnostic.php" id="act_frm" method=post enctype="multipart/form-data">

...
?>  
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Hospitalization Record Summary</h1>
      <b>
	...
	<!--
	  ...
	  <input type=text name=start_date class=txtfield1 style='width:100px;' id=start_date onclick='ds_sh(this,"start_date")' value='<?= date("Y-m-01",time()) ?>' />
	  
	  </td><td>
	  <input type=text  name=end_date class=txtfield1 style='width:100px;' id=end_date onclick='ds_sh(this,"end_date")' value='<?= date("Y-m-t",time()) ?>' />
	  ...
	  <h1 style=''>Hospitalization Register CPC</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		if($("#end_date").val().trim() == $("#start_date").val().trim()){
			if(!confirm("Generate TB SCREENING REPORT For " + $("#end_date").val() + " Only?"))
				return e.preventDefault();
		}
		if($("#end_date").val().trim() < $("#start_date").val().trim()){

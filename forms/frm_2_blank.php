...
$count_consult = 3; count($conslt = formatResultSet($rslt=returnResultSet($sql="SELECT co_category.* from co_category, se_consultation WHERE se_consultation.ServiceID = '1' && se_consultation.ConsulationID = co_category.ConsultationCategoryID",$con),$multirows=true,$con));
...
if($records){
	//$records[] = $records[0];
	$last .= "<div>
	Historique 2 dernierès visites
	...
	<tr>
		<td colspan=2>
			<table class=inner_table width=100% style='width:100%'>
				<tr>
					<td colspan=3><br />&nbsp;CBHI Code: <b>{$record['InsuranceCardID']}</b></td>
					<td>Village: <b>{$patient_address['VillageName']}</b></td>
				</tr>
				<tr>
					<td style='width:370px'><br />&nbsp;Patient: <b>{$patient['Name']}</b></td>
				...
				<tr>
					<td><br />&nbsp;Family Chief: <b>{$patient['FamilyCode']}</b></td>
			...
			<table class='withborders' style='width:900px;border-collapse:collapse;'>
				...
				<tr valign=top>
					...
					<td colspan='{$count_consult}'>
						Hospitalization: Days and Type: <br />
						Date In: ......./........./.........&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Date Out: ......./......../.........&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>

...
<style>
	...
	._history td{vertical-align:top; border-bottom:1px solid #000; font-size:9px; font-weight:bold; font-family:arial; }
	.med_info{ font-size:12px; font-family:arial; }
	.med_header{ font-size:20px; font-family:arial; }
</style>
	...
	<tr>
		<th align=left>
			<table border=0 style='width:900px;'>
				<tr>
					<td style='text-align:left; width:100px;'><!--<img src='../images/corar.png' /> --></td>
					<td style='text-align:center;'>
						<div class=med_header>
							COMPANGIE RWANDAISE D'ASSURANCE ET DE REASSURANCE "CORAR S.A."
						</div>
						<div class=med_info>
							SIEGE: CENTENARY HOUSE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; B.P. 3869 KIGALI-RWANDA<br />
							Tel: 501211; Fax: 575596; E-mail:corar@rwanda1.com
						</div>
					</td>
				</tr>
			</table>
	...
	<tr>
		<td>
			<table class=inner_table width=100% style='width:100%'>
				<tr>
					<td colspan=2>Etablissement de sanitaire: <b>{$institution_name}</b></td>
		...
		<td style='border:0px solid #f00;'>
			...
			<table class='withborders' style='width:900px;border-collapse:collapse;'>
				...
				<tr valign=top>
					...
					<td colspan='{$count_consult}'>Hospitalization: 
					<table class=withborders style='width:400px; text-align:center; border-collapse:collapse;'>
						<tr>
							<td >Date d'Entree</td><td >Date de Sortie</td>
							<td >Nbr Jours</td>
						</tr>
						<tr>
							<td style='height:25px;'>&nbsp;</td><td ></td><td ></td>
						</tr>
					</table>
					</td>
				</tr>

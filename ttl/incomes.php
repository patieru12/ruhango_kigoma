...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Monthly Income Summary</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='height:95%; border:0px solid #000;'>
		<span class=error-text>Select Post to view Monthly Incomes</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("monthly_income.php?key=" + $("#insurance").val() + "&month=" + $("#month").val() + "&year=" + $("#year").val() + "&post=" + $("#post").val());
	});

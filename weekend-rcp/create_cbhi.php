...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <table border=0 style='background-color:#fff;'>
		...
		<tr class="patient_found_search">
			...
			<div class="patient_found"></div></td>
					...
					<tr>
						...
						<td style='width:100px; font-size:14px'>Insurance card </td>
					</tr>
				</table>
		...
		<tr><td class=h_label>House Manager<span class=error-text>*</span></td></td><td class=fcategory>Category<span class=error-text>*</span></td></td><td class=affection_location></td><td class=sex></td>
		</tr>

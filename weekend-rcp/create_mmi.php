...
//die;
//var_dump($_SESSION);
$insurance = formatResultSet($rslt=returnResultSet($sql="SELECT DISTINCT in_name.* from in_name, in_category, in_forms, in_price WHERE in_name.CategoryID=in_category.InsuranceCategoryID && in_name.InsuranceNameID = in_forms.InsuranceNameID && in_name.InsuranceName='MMI' && in_name.InsuranceNameID = in_price.InsuranceNameID ORDER BY InsuranceCode ASC, InsuranceName DESC",$con),$multirows=true,$con);
...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <h1>MMI PATIENT MEDICAL DOCUMENT</h1>
	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		...
		<tr>
			<td class=tm_view colspan=4 style='border:0px solid #000; padding-top: 10px;'>
				<label><input type=radio id='paid' name='tm' value='200' />TM Paid</label>
		...
		<input type=submit id=save class="flatbtn-blu" name=rcv_patient value='Save' /> <input type=reset class="flatbtn-blu" onclick='window.location="./create_mmi.php";' value='Clear' /></td></tr>
	  </table>

		...
		<tr>
			<td colspan="6">
				<table class="b">
					...
					<tr>
						<!-- <td><input type=text name='weight' autocomplete="off" id='weight' class='txtfield3' style='' /></td>
						<td><input type=text name='temperature' autocomplete="off" id='temperature' class='txtfield3' style='' /></td>
						<td><input type=text name='length' autocomplete="off" id='length' class='txtfield3' style='' /></td>
						<td><input type=text name='Respiration' autocomplete="off" id='Respiration' class='txtfield3' style='' /></td>
						<td><input type=text name='Pressure' autocomplete="off" id='Pressure' class='txtfield3' style='' /></td>
						<td><input type=text name='Pulse' autocomplete="off" id='Pulse' class='txtfield3' style='' /></td>
						<td><input type=text name='SPO2' autocomplete="off" id='SPO2' class='txtfield3' style='' /></td>
						<td><input type=text name='Group' autocomplete="off" id='Group' class='txtfield3' style='' /></td> -->
					</tr>
				</table>
			</td>
		</tr><!--
...
function OTHER(){
	$(".tm_view").html("<label><input type=radio id='paid' name='tm' value='<?= $tm_to_pay ?>' /> Paid <?= $tm_to_pay ?> RWF</label><input type=text placeholder='Receipt Number' id=receipt_number name=receipt_number class=txtfield1 style='width:70px;' />");

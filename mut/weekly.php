...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Weekly Report</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("weekly_data.php?key=" + $("#insurance").val() + "&start_date=" + $("#start_date").val() + "&end_date=" + $("#end_date").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
